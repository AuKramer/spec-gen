...
G = 1/(σ√(2π) exp[-(x-a)^2/ (2 σ^2)]. Then, σ is the usual standard deviation represented by the Gaussian, and the full width of the peak at half peak height (FWHH) is 2σ √(ln(4)). With Lorentzian broadening, the normalized function used is L = γ / [2π (x-a)^2 + (γ/2)^2] with a FWHH of γ. 
